...
local FONT_SIZE = nil --(number, integer, optional) font size of the text, not used for bitmap fonts
...
local BANNER_HEIGHT = 28 --(number, non-negative integer, optional) height of banner in pixels, 0 or nil/false for no banner
